...
type FeatureTranslation = { title: string; description: string }
...
export default async function Home() {
  ...
  const featuresTranslations = t.raw("features_items") as FeatureTranslation[]
  const testimonials = t.raw("testimonials_items") as TestimonialItem[]
  const faqsTranslations = t.raw("faqs_items") as FaqTranslation[]

  const localizedFeatures = features.map((f, i) => ({
    ...f,
    title: featuresTranslations[i]?.title ?? f.title,
    description: featuresTranslations[i]?.description ?? f.description,
  }))

  const localizedFaqs = faqs.map((f, i) => ({
    ...f,
    question: faqsTranslations[i]?.question ?? f.question,
    answer: faqsTranslations[i]?.answer ?? f.answer,
  }))
          ...
          <div className="hidden xl:block" aria-hidden>
            ...
            <div className="animate-float-slow hero-fade-in hero-d6 absolute top-12 right-32 w-52 rounded-2xl border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_20px_40px_rgba(0,0,0,0.3)]">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[11px] font-medium text-muted-foreground tracking-wide uppercase">{t("hero_users")}</span>
              </div>
            ...
            <div className="animate-float-slow hero-fade-in hero-d6 absolute top-24 left-20 w-44 rounded-2xl border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_20px_40px_rgba(0,0,0,0.3)] [animation-delay:3s]">
              <div className="text-[11px] text-muted-foreground uppercase tracking-wide mb-3">{t("hero_stack")}</div>
              ...
              <div className="mb-16 text-center">
                <div className="badge-beam mb-4" data-gsap="badge">
                  ...
                  <div className="badge-beam-inner">
                    <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">{t("features_badge")}</span>
                  </div>
                </div>
                ...
                <p className="text-muted-foreground text-lg" data-gsap="subtitle">{t("features_subtitle")}</p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="mb-16 text-center">
              <div className="badge-beam mb-4" data-gsap="badge">
                <div className="badge-beam-ring" />
                <div className="badge-beam-inner">
                  <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">{t("testimonials_badge")}</span>
                </div>
              </div>
              <h2 className="mb-4 text-4xl font-bold tracking-tight lg:text-5xl" data-gsap="title">
                <span className="bg-gradient-to-b from-foreground via-foreground to-foreground/40 bg-clip-text text-transparent">
              ...
              <p className="text-muted-foreground text-lg" data-gsap="subtitle">{t("testimonials_subtitle")}</p>
            </div>
            ...
            <div className="container mx-auto max-w-2xl px-4">
              <div className="mb-16 text-center">
                <div className="badge-beam mb-4" data-gsap="badge">
                  <div className="badge-beam-ring" />
                  <div className="badge-beam-inner">
                    <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">{t("faq_badge")}</span>
                  </div>
                </div>
                <h2 className="mb-4 text-4xl font-bold tracking-tight lg:text-5xl" data-gsap="title">
                  <span className="bg-gradient-to-b from-foreground via-foreground to-foreground/40 bg-clip-text text-transparent">
                ...
                <p className="text-muted-foreground text-lg" data-gsap="subtitle">{t("faq_subtitle")}</p>
              </div>
