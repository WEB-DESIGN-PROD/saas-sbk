            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  {isLoading
                    ? "Chargement…"
                    : `${filteredMedia.length} fichier${filteredMedia.length !== 1 ? "s" : ""}${search ? " trouvé" + (filteredMedia.length !== 1 ? "s" : "") : " dans la bibliothèque"}`}
                </p>
              </div>
              ...
              {filteredMedia.map((item, index) => {
                ...
                return (
                  <div key={item.key} className="group relative space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground px-0.5">{formatSize(item.size)}</p>
                  </div>
                )
              })}
            </div>
        ...
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              sera définitivement supprimé du stockage. Cette action est irréversible.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={confirmDelete} disabled={isDeleting}>
              {isDeleting ? (
                <><Loader2 className="mr-2 size-4 animate-spin" />Suppression…</>
              ) : (
      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={confirmRename} disabled={!newBaseName.trim() || isRenaming}>
              {isRenaming ? (
