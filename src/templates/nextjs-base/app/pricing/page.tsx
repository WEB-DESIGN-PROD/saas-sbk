      ...
      <main className="flex-1">
        ...
        <section className="py-24 text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="mb-8 text-muted-foreground" data-gsap="subtitle">14 jours d&apos;essai gratuit, sans carte bancaire requise.</p>
            <Button size="lg" className="gap-2 shadow-[0_0_25px_rgba(0,0,0,0.3)] hover:shadow-[0_0_35px_hsl(var(--primary)/30%)] transition-all duration-300" asChild>
              <Link href="{{AUTH_ENTRY_URL}}">Commencer gratuitement <ArrowRight className="h-4 w-4" /></Link>
            </Button>
          </div>
        </section>
