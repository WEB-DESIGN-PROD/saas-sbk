...
export function Navbar({ headerPages = [] }: { headerPages?: NavPage[] }) {
  ...
  return (
    <div className="sticky top-0 z-50 flex justify-center px-4 pt-3 pb-1 pointer-events-none" style={{ background: "linear-gradient(to bottom, var(--background) 60%, transparent)" }}>
